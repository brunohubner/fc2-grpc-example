...
func (x *userServiceAddUserVerboseClient) Recv() (*UserResultStrem, error) {
	m := new(UserResultStrem)
...
func (x *userServiceAddUserStreamBothClient) Recv() (*UserResultStrem, error) {
	m := new(UserResultStrem)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *userServiceAddUserVerboseServer) Send(m *UserResultStrem) error {
...
func (x *userServiceAddUserStreamBothServer) Send(m *UserResultStrem) error {
	return x.ServerStream.SendMsg(m)
}
